...
<div class="row">
 <div class="col-md-2 box-button-save">
            <button type="button" class="mb-xs mt-xs mr-xs btn btn-grey" onclick="document.location='/<?php echo strtolower(\Application::getNameController()); ?>/cadastrar-roteiro'"><i class="material-icons material-align-icons-button">&#xE145;</i>&nbsp;Novo Roteiro</button>
    </div>
          ...
          <div class="row">
                <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select name="idBanco" id="idBanco" class="form-control mb-md">
                                    <option></option>
                                    <?php 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select name="idEntidade" id="idEntidade" class="form-control mb-md">
                                    <option></option>
                                    <?php 
            ...
            { "data": "nomeEntidade" },
             { "data": "id",
                    "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
                        $(nTd).html('<a class="link-visualizar" href="/<?php echo strtolower(\Application::getNameController()); ?>/cadastrar-roteiro/'+  oData.id+'"><i class="material-icons">&#xE254;</i></a>');
                    }
            },
